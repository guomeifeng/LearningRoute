...
<title>登陆页面AngularJS $http Example</title>
...
<body ng-app="myApp" ng-controller="userController">
		...
		<div id="loginBlock" class="login"
			...
			<div class="loginForm">
				<form id="loginform" name="loginform" method="post" class="niceform"
					ng-submit="userController.submit()">
					<div id="idInputLine" class="loginFormIpt showPlaceholder"
						style="margin-top: 5px;">
						<input ng-model="username" id="loginform:idInput" type="text" name="user.username"
							class="loginFormTdIpt" maxlength="50" />
						<label for="idInput" class="placeholder" id="idPlaceholder">帐号：</label>
					</div>
					<div class="forgetPwdLine"></div>
					<div id="pwdInputLine" class="loginFormIpt showPlaceholder">
						<input ng-model="password" id="loginform:pwdInput" class="loginFormTdIpt" type="password"
	...
	<script src="${pageContext.request.contextPath }/js/angular.min.js"></script>  
      ...
      <script src="<c:url value='/angularJS/userService.js' />"></script>  
      <script src="<c:url value='/angularJS/userController.js' />"></script>  
</body>
</html>