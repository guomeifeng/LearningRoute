...
public class BatchConfiguration extends DefaultBatchConfigurer {
    ...
    @Bean
    public JobRepository jobRepository(C3p0DataSourceDBConfig dataSource, HibernateTransactionManager dataSourceTransactionManager) throws Exception {
     ...
     */
    @Bean
    StepBuilderFactory stepBuilderFactory(JobRepository jobRepository, HibernateTransactionManager dataSourceTransactionManager) {
