			...
			if (v){
				...
				if (v1 == v2){
					...
					$.post("/user/editPassword",{"password":v1},function(data){
						if (data=='1'){
							//修改密码成功，关闭窗口
							$.messager.alert("消息提示","修改密码成功！","warning");
							$("#editPwdWindow").window("close");
						}else{
							//修改密码失败，弹出提示
							$.messager.alert("消息提示","修改密码失败！","error");
						}
					});
				
				}else{
					$.messager.alert("消息提示","俩次密码输入不一致！","warning");
				}  
			} 
		});
	});
	...
	<div data-options="region:'center'">
		<div id="tabs" fit="true" class="easyui-tabs" border="false">
			<div title="消息中心" id="subWarp"
				...
				<iframe src="${pageContext.request.contextPath }/common/home"
            ...
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                <form id="editPasswordForm">
	                <table cellpadding=3>
	                    <tr>
	                        <td>新密码：</td>
	                        <td><input required = "required" id="txtNewPass" type="Password" data-options="validType:'length[4,6]'" class="txt01 easyui-validatebox" /></td>
	                    </tr>
	                    <tr>
	                        <td>确认密码：</td>
	                        <td><input required = "true" id="txtRePass" type="Password" data-options="validType:'length[4,6]'" class="txt01 easyui-validatebox" /></td>
	                    </tr>
	                </table>
                </form>
            </div>
