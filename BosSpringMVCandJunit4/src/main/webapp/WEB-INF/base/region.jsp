...
<script type="text/javascript">
	...
	function doView(rowIndex, rowData){
		...
		if (rows.length==0){
			...
			$.messager.confirm("确认","确认要删除选中的条目吗？",function(r){
				if (r){					
					...
					location.href="regionAction_deleteRegion.action?ids="+array.join(",");
				}
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="区域修改" id="editRegionWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		<div region="north" style="height:31px;overflow:hidden;" split="false" border="false" >
			<div class="datagrid-toolbar">
				<a id="editSave" onclick="editSaveOnClick()" icon="icon-save" href="#" class="easyui-linkbutton" plain="true" >保存</a>
			</div>
		</div>
